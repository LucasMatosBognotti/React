...
function App() {
  ...
  function getGeocoding(value) {
    const Key = ('AIzaSyDiTVZ6eRGQ8pAixwJZMxxAegW74rllTSw');
          ...
          <Content>
            ...
            <Map>
              <ReactMapGL
                ...
                width="100%"
                height="70vh"
                mapboxApiAccessToken="pk.eyJ1IjoienVtYnkyMDAwIiwiYSI6ImNrNmM4MTE2MDEwMWMzbm4zMXd5ejRiczcifQ.19Z-ZQZZtO2qkMGo5lnkTA"
